...
const { snowyID } = require('../json/config.json')
const { renegadeID } = require('../json/config.json')
const { specialID } = require('../json/config.json')
...
exports.run = (client, message, args) => {
    ...
    if (user == snowyID || (user == renegadeID || (user == specialID))) {
        ...
        if (args == "yiff") {
            ...
            return message.channel.send("Sorry, you're not in the **Special-IDs** category.")
    }
