...
module.exports = (client, message) => {
    ...
    console.log(chalk.white.bold(`< LOGGED IN || Current Users: ${client.users.size}, Current Servers: ${client.guilds.size} >`));
    console.log(chalk.white.bold(`< MADE BY FEARTHERENEGADE#7276 >`));
    console.log(chalk.blue.bold(`------------------------------------------------------`));
